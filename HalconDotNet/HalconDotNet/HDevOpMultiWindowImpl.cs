...
{
    /// <summary>
    /// Convenience implementation of HDevOperators managing multiple windows
    /// </summary>
    public class HDevOpMultiWindowImpl : HDevOpFixedWindowImpl
    {
        /// <summary>
        /// Window IDs of all open windows
        /// </summary>
        protected HTuple windowIDs;
        /// <summary>
        /// Window IDs of all designated external windows
        /// </summary>
        protected HTuple fixedIDs;
        /// <summary>
        /// Flags indicating whether a fixed window is "dev-open"
        /// </summary>
        ...
        /// <summary>
        /// Creates an instance with no fixed windows
        /// </summary>
