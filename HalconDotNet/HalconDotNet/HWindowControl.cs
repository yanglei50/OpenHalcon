...
// Type: HalconDotNet.HWindowControl
...
namespace HalconDotNet
{
    ...
    public class HWindowControl : UserControl
    {
        ...
        {
            this.Name = nameof(HWindowControl);
        ...
        /// <summary>Width of optional border in pixels</summary>
        [Category("Appearance")]
        [DefaultValue(0)]
        ...
        /// <summary>Color of optional border around window</summary>
        ...
        /// <summary>Adapt ImagePart to show the full image.</summary>
