...
namespace HalconNewVSIX
{
    ...
    internal sealed class MyCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("3504e1e3-eb85-473b-b4ee-bd9cc0bf4fd0");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            string message = "Hello World!";// string.Format(CultureInfo.CurrentCulture, "Inside {0}.MenuItemCallback()", this.GetType().FullName);
